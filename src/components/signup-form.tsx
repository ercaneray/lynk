...
export function SignupForm({ className, ...props }: React.ComponentProps<"div">) {
    ...
    const onSubmit = async ({ email, password, confirmPassword }: Inputs) => {
                    ...
                    <form className="p-6 md:p-8">
                        <div className="flex flex-col gap-6">
                            <div className="flex flex-col items-center text-center">
                                <h1 className="text-2xl font-bold">Welcome to Lynk</h1>
                                <p className="text-balance text-muted-foreground">Let&apos;s create your accont</p>
                            </div>
